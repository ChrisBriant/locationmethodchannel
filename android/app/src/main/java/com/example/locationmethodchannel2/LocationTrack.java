...
public class LocationTrack extends Service implements LocationListener {
    private static LocationTrack single_instance;
    ...
    public static LocationTrack getInstance()
    {
        if (single_instance == null)
            single_instance = new LocationTrack();

        return single_instance;
    }

    public void initLocation(Context mContext, Activity act) {
                ...
                if (checkGPS) {
                    ...
                    if (ActivityCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(mActivity,new String[]{Manifest.permission.ACCESS_FINE_LOCATION,Manifest.permission.ACCESS_COARSE_LOCATION},
                                1);
                        Log.d("Permissions","Should ask permissions here");
                    }
